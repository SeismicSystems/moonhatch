 ...
 * successful.
 * To use this library you can add a `using SafeERC20 for ISRC20;` statement to your contract,
...
library SafeSRC20 {
     ...
     */
    function _callOptionalReturn(ISRC20 token, bytes memory data) private {
        uint256 returnSize;
        uint256 returnValue;
     ...
     */
    function _callOptionalReturnBool(ISRC20 token, bytes memory data) private returns (bool) {
        bool success;
        uint256 returnSize;
        uint256 returnValue;
        assembly ("memory-safe") {
