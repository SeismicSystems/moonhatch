...
const Description: React.FC = () => (
  <div className="flex flex-col gap-2 text-center mb-6">
    ...
    <p className="text-[var(--creamWhite)] text-sm sm:text-base">
      buyers receive a
      <span className="text-orange-400"> randomly generated price </span>
      so they don't know their allocation until graduation
    </p>
  </div>
)
            ...
            >
              <DialogPanel className="bg-[var(--darkBlue)] rounded-lg w-full max-w-lg p-6 relative">
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <Step number={2}>
                    buy it. your price will be generated by our on-chain rng.
                    the average price across all buys will be 1b tokens for 1
                    testETH
                  </Step>
                  <Step number={3}>
